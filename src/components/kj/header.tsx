      ...
      >
        ...
        <div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between px-6 lg:px-10">
          ...
          <form
            ...
            className="hidden w-[420px] flex-shrink-0 items-center gap-2.5 rounded-full bg-white/10 px-4 py-1.5 transition-colors hover:bg-white/15 focus-within:bg-white/15 md:flex"
          >
