...
export function AboutPage({ onNavigate }: AboutPageProps) {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(180deg, #F6F7F2 0%, #EAF4E6 50%, #F6F7F2 100%)",
      }}
    >
      ...
      <section className="relative w-full overflow-hidden">
        <div className="relative h-[40vh] min-h-[280px] w-full">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#20231F]/80 via-[#20231F]/20 to-transparent" />
          <div className="absolute inset-0 flex items-end">
            <div className="mx-auto w-full max-w-[1280px] px-6 pb-8 lg:px-10">
              <motion.p
                ...
                className="text-[11px] font-semibold uppercase tracking-[0.25em] text-[#287E05]"
              >
                Hammerfest · 70°N
              </motion.p>
              <motion.h2
      ...
      <section className="mx-auto max-w-[1280px] px-6 py-20 lg:px-10 lg:py-28">
        ...
        <div className="mb-16 max-w-3xl">
          ...
          <h1
            className="text-[clamp(3rem,6vw,4.5rem)] font-bold leading-[1.05] tracking-[-0.02em] text-[#20231F]"
            style={{ fontFamily: "var(--font-manrope), sans-serif" }}
          >
            {t("about.title")}
          </h1>
          <p className="mt-6 text-[20px] font-medium text-[#20231F]">
            {t("about.since")}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[420px_1fr] lg:gap-16">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -right-5 hidden rounded-lg bg-white px-5 py-4 shadow-[0_10px_25px_rgba(31,45,58,0.18)] sm:block">
              <div className="text-[24px] font-bold text-[#20231F]">40+</div>
              <div className="text-[11px] font-light uppercase tracking-[0.1em] text-[#687066]">
                {t("about.yearsBadge")}
              </div>
            </div>
          </div>
          ...
          <div className="max-w-[680px]">
            <p className="text-[18px] font-light leading-[1.85] text-[#20231F]">
            ...
            <p className="mt-6 text-[18px] font-light leading-[1.85] text-[#20231F]">
            ...
            <div className="mt-10 flex items-center gap-4">
              <div className="h-px flex-1 bg-[#20231F]/15" />
              <span className="text-[14px] font-light italic text-[#687066]">
                {t("about.signature")}
              </span>
            </div>
            ...
            <button
              ...
              className="mt-10 inline-flex items-center gap-3 rounded-full bg-[#20231F] px-8 py-4 text-[13px] font-semibold uppercase tracking-[0.12em] text-[#287E05] shadow-[0_8px_24px_rgba(31,45,58,0.25)] transition-all duration-300 hover:bg-[#194D04] hover:shadow-[0_12px_30px_rgba(31,45,58,0.35)]"
            >
              {t("about.cta")}
              <ArrowRight
                size={16}
        ...
        <div className="mt-24 grid grid-cols-2 gap-8 border-t border-black/10 pt-12 md:grid-cols-4">
          {[
            ...
            <div key={s.l}>
              <div className="text-[clamp(2rem,3vw,2.75rem)] font-bold text-[#20231F]">
                {s.v}
              </div>
              <div className="mt-2 text-[12px] font-light uppercase tracking-[0.15em] text-[#687066]">
                {s.l}
              </div>
            </div>
          ))}
